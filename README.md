...
- [Env & Deploy](Backend/env&deploy.md)
- [Gunicorn & Whitenoise](Backend/gunicorn&whitenoise.md)
- [Postgres SQL & JWT](Backend/Postgres&JWT.md)
- [Python File & Restframework](Backend/Python&rest.md)
